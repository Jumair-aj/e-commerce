...
Banner() {
  return (
    <div className=' px-12 h-[24rem] flex mt-5'>
        ...
        <div className="bg-[#8d1e23] h-full flex flex-col  justify-center banner_border_radius ">
        ...
        <div className=" h-full w-3/6 flex items-end justify-center absolute right-0" data-aos="zoom-in" data-aos-duration="400" data-aos-easing="ease-out-back" >
