  ...
  return (
    <div className=' px-12 mt-5 h-[22rem] flex'>
        ...
        <div className="bg-[#8d1e23] h-full flex flex-col items-center justify-center banner_border_radius ">
            <div className=' w-3/5'  data-aos="fade-up" data-aos-duration="400" data-aos-easing="ease-out-back" data-aos-delay='100'>  
        ...
        <div className=" h-full w-3/6 flex items-end justify-center absolute right-0" data-aos="fade-up" data-aos-duration="400" data-aos-delay='100' data-aos-easing="ease-out-back" >
