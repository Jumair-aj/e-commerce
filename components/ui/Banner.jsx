...
Banner() {
  return (
    <div className=' px-12 h-[24rem] flex mt-5'>
        ...
        <div className="bg-[#8d1e23] h-full flex flex-col  justify-center banner_border_radius h-[26rem] relative bottom-[1rem]">
        ...
        <div className=" h-full w-3/6 flex  justify-center absolute right-0  flex items-start pt-20" data-aos="zoom-in" data-aos-duration="400" data-aos-easing="ease-out-back" >
